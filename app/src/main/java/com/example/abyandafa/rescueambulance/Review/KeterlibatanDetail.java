...
public class KeterlibatanDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keterlibatan_detail);
...
//        FollowUpActivity = (TextView) findViewById(R.id.detail_followup);
...
//            public void onClick(View v) {
//
//                Intent reviewIntent = new Intent(KeterlibatanDetail.this, ReviewActivity.class);
...
//        callDetailTransaction();
    ...
    private void callDetailTransaction() {
        ...
        Call<APIResponse> result = apiClient.transaksiDetail(spAmbulan.getSpToken(), spTransaksi.getID());
        ...
        result.enqueue(new Callback<APIResponse>() {
            ...
            public void onFailure(Call<APIResponse> call, Throwable t) {
                ...
                Toast.makeText(KeterlibatanDetail.this, "Kesalahan System", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        });
